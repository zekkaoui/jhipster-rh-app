package tech.alphalupi.rhapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(tech.alphalupi.rhapp.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(tech.alphalupi.rhapp.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
